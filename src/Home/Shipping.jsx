      ...
      <section>
        <main className="">
                    ...
                    <div className="max-w-[197.56px] w-full flex flex-col justify-center items-center gap-[11.98px]">
                      <div className="flex flex-col justify-center items-center gap-[53.81px]">
                        <img
                          ...
                          alt="shippingimg"
                        />
                        <h4 className="font-poppins text-primary-dark font-[500] text-[27px] leading-[100%]">
                          {item.tittle}
                        </h4>
                      </div>
                      <p className="font-proxima font-normal text-center text-[18px] leading-[100%] text-primary-dark">
          ...
          <div className="flex flex-col justify-center items-center gap-[71.97px] max-w-[1212.93px] w-full px-5 mx-auto pb-[110.04px] ">
            <h1 className="font-poppins font-[600] flex justify-center items-center h-[51px]  text-[34px] leading-[100%] text-primary-dark">
              LATEST NEWS
            </h1>
                  ...
                  <div key={index + item + Date.now()}>
                    ...
                    >
                      ...
                      <div className="flex flex-col w-[197.56px]">
                        <h4 className="text-lightgray-white mb-[2.2px]  font-poppins font-[500] text-[18px] leading-[100%]">
                          01 Jan, 2015
                        </h4>
                        <h4 className="text-primary-dark h-[33px] flex  items-center font-poppins font-[600] text-[22px] leading-[100%]">
                          {item.tittle}
                        </h4>
                        <p className="text-primary-dark font-proxima font-normal text-[18px] leading-[100%]">
                          Lorem Ipsum is simply dummy text of the printing and
                          typesetting industry.
                        </p>
                      </div>
          ...
          <div className="flex flex-col pb-[110.04px] justify-center items-center max-w-[1304.98px] w-full mx-auto px-5 gap-[55.44px]">
            <h1 className="text-primary-dark font-poppins font-[600] text-[35px] leading-[100%] h-[53px] justify-center items-center flex">
              FEATURED PRODUCTS
            </h1>
            <div className="flex">
              {data.datanews.map((item, index) => {
                  ...
                  <div key={index + item + Date.now()}>
                    <div className="flex w-[428px]  justify-between">
                      ...
                      <div className="flex flex-col w-[249.29px] gap-[17.34px]">
                        <h1 className="text-primary font-proxima font-normal text-[22px] leading-[100%]">
                        ...
                        <div className="flex w-[104.27px] justify-between items-center ">
                          <h4 className="text-primary-red font-poppins font-[500] text-[20px] leading-[100%]">
                            $499
                          </h4>
                          <h4 className="text-lightgray-white line-through font-poppins font-[500] text-[20px] leading-[100%]">
                            $599
                          </h4>
                        </div>
                      </div>
