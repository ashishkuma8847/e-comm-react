          ...
          <div className="container ">
            <div className="flex relative  text-white">
              <div className="w-[592px] h-[600px] justify-center flex flex-col  ">
                <h1 className="font-poppins font-[500] text-[55px] leading-[100%] mb-[23.34px]">
                  Adidas Men Running Sneakers
                </h1>
                <p className="mb-[12.11px] font-poppins font-[400] text-[24px] leading-[100%]">
                  Performance and design. Taken right to the edge.
                </p>
                <button className="font-poppins w-[111px] h-[30px] font-[600] text-[20px] leading-[100%]">
                  SHOP NOW
                </button>
