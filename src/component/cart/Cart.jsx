        ...
        <main>
          ...
          <div className="container">
            <div className="flex flex-col">
              <div className="flex flex-col">
                <div className="w-full pb-[23px] border-b-2 border-sidegray mb-[40px] pl-[50.46px] flex justify-between items-center font-poppins font-[500] text-xl">
                  <h4>PRODUCT</h4>
                    ...
                    <div key={index + item + Date.now()}>
                      <div className="flex  items-center justify-between">
                        <div className="flex items-center max-w-[435.47px] w-full justify-between">
                          ...
                          <div className="flex items-center gap-[28.7px]">
                            <img
              ...
              <div className="flex justify-between pb-[156.47px]">
                <div className="flex  items-center">
                  <input
                    className="w-[251px] text-primary opacity-[50%] p-[19px_0_17px_20px] h-[60px] font-poppins font-normal text-[16px]  outline-none border-t-2 border-b-2 border-l-2 border-roundedgray rounded-bl-[3px] rounded-tl-[3px]"
                    type="text"
                    placeholder="Voucher code"
                  />
                  <button className="w-[127px] p-[18px_21px_14px_21px] font-poppins h-[60px] font-[500] text-[18px] text-white bg-primary-blue rounded-r-[3px]">
                    Redeem
                  </button>
                </div>
